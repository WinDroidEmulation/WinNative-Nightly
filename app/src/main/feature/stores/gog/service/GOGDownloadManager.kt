...
class GOGDownloadManager @Inject constructor(
    ...
    suspend fun downloadGame(
        ...
        try {
            ...
            com.winlator.cmod.app.PluviaApp.events.emitJava(
                com.winlator.cmod.feature.stores.steam.events.AndroidEvent.DownloadStatusChanged(gameId.toIntOrNull() ?: 0, true),
            )
            ...
            com.winlator.cmod.app.PluviaApp.events.emitJava(
                com.winlator.cmod.feature.stores.steam.events.AndroidEvent.DownloadStatusChanged(gameId.toIntOrNull() ?: 0, false),
            )
    ...
    private suspend fun finalizeInstallSuccess(gameId: String, installPath: File, downloadInfo: DownloadInfo) {
        ...
        com.winlator.cmod.app.PluviaApp.events.emitJava(
            com.winlator.cmod.feature.stores.steam.events.AndroidEvent.LibraryInstallStatusChanged(gameId.toIntOrNull() ?: 0),
        )
    }

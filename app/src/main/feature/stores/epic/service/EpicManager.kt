...
class EpicManager @Inject constructor(
    ...
    suspend fun fetchManifestSizes(context: Context, appId: Int): ManifestSizes = withContext(Dispatchers.IO) {
        try {
            ...
            val manifest = com.winlator.cmod.feature.stores.epic.service.manifest.EpicManifest.readAll(manifestData.manifestBytes)
            ...
            val (downloadSize, installSize) = com.winlator.cmod.feature.stores.epic.service.manifest.ManifestUtils.getSizesForSelectedInstallTags(manifest, emptyList())
            Timber.tag("Epic").d(

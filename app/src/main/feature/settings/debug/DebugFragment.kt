...
class DebugFragment : Fragment() {
                ...
                MaterialTheme(
                    ...
                    DebugScreen(
                        ...
                        onAppDebugChanged = { checked ->
                            ...
                            if (checked) {
                                com.winlator.cmod.runtime.system.LogManager.startAppLogging(ctx)
                            } else {
                                com.winlator.cmod.runtime.system.LogManager.stopAppLogging()
                                com.winlator.cmod.runtime.system.LogManager.updateLoggingState(ctx)
                            }
                            refresh()
                        },
    ...
    private fun shareLogs() {
        val ctx = requireContext()
        val files = com.winlator.cmod.runtime.system.LogManager.getShareableLogFiles(ctx)

...
public abstract class WineUtils {
    ...
    public static String getSdCardRootPath() {
        try {
            if (!com.winlator.cmod.feature.stores.steam.utils.PrefManager.INSTANCE.getUseExternalStorage()) return null;
            String path = com.winlator.cmod.feature.stores.steam.utils.PrefManager.INSTANCE.getExternalStoragePath();

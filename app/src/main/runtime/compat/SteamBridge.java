...
public class SteamBridge {
    ...
    public static String getAppDirPath(int appId) {
        try {
            Class<?> companion = Class.forName("com.winlator.cmod.feature.stores.steam.service.SteamService$Companion");
            Object instance = Class.forName("com.winlator.cmod.feature.stores.steam.service.SteamService")
    ...
    public static boolean isLoggedIn() {
        try {
            Class<?> serviceClass = Class.forName("com.winlator.cmod.feature.stores.steam.service.SteamService");
            Class<?> companion = Class.forName("com.winlator.cmod.feature.stores.steam.service.SteamService$Companion");

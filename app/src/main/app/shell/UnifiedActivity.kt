...
class UnifiedActivity : AppCompatActivity(), ActivityResultHost {
    ...
    private val wallpaperImagePickerLauncher =
        registerForActivityResult(ActivityResultContracts.GetContent()) { uri ->
            ...
            val bitmap = com.winlator.cmod.shared.android.ImageUtils.getBitmapFromUri(this, uri, 1280)
            if (bitmap != null) {
                val wallpaperFile = com.winlator.cmod.runtime.wine.WineThemeManager.getUserWallpaperFile(this)
                com.winlator.cmod.shared.android.ImageUtils.save(bitmap, wallpaperFile, Bitmap.CompressFormat.PNG, 100)
            }
        }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!SetupWizardActivity.isSetupComplete(this) || !ImageFs.find(this).isValid) {
            ...
            com.winlator.cmod.shared.android.AppUtils.applyOpenActivityTransition(this, 0, 0)
            finish()
            return
        }
                    ...
                    composable(
                        ...
                        if (editContainerId > 0) {
                            LaunchedEffect(editContainerId) {
                                ...
                                if (container != null) {
                                    com.winlator.cmod.feature.settings.ContainerSettingsComposeDialog(
                                        activity, container
                ...
                if (code != null) {
                    scope.launch {
                        ...
                        if (authResult.isSuccess) {
                            com.winlator.cmod.shared.android.AppUtils.showToast(context, R.string.stores_accounts_logged_in_epic, android.widget.Toast.LENGTH_SHORT)
                        } else {
                            com.winlator.cmod.shared.android.AppUtils.showToast(context, getString(R.string.stores_accounts_epic_login_failed, authResult.exceptionOrNull()?.message), android.widget.Toast.LENGTH_LONG)
                        }
                    }
                }
            }
            ...
            if (result.resultCode == android.app.Activity.RESULT_OK) {
                ...
                if (!code.isNullOrBlank()) {
                    scope.launch {
                        ...
                        if (authResult.isSuccess) {
                            GOGService.start(context)
                            com.winlator.cmod.shared.android.AppUtils.showToast(context, R.string.stores_accounts_logged_in_gog, android.widget.Toast.LENGTH_SHORT)
                        } else {
                            com.winlator.cmod.shared.android.AppUtils.showToast(context, getString(R.string.stores_accounts_gog_login_failed, authResult.exceptionOrNull()?.message), android.widget.Toast.LENGTH_LONG)
                        }
                    }
                }
            }
                ...
                scope.launch(kotlinx.coroutines.Dispatchers.IO) {
                    try {
                        ...
                        withContext(kotlinx.coroutines.Dispatchers.Main) {
                            com.winlator.cmod.shared.android.AppUtils.showToast(context, R.string.saves_import_export_exported, android.widget.Toast.LENGTH_SHORT)
                            onDismissRequest()
                        }
                    } catch (e: Exception) {
                        e.printStackTrace()
                        withContext(kotlinx.coroutines.Dispatchers.Main) {
                            com.winlator.cmod.shared.android.AppUtils.showToast(context, getString(R.string.saves_import_export_exported_failed, e.message), android.widget.Toast.LENGTH_SHORT)
                        }
                    }
                }
            }
            ...
            if (uri != null) {
                scope.launch(kotlinx.coroutines.Dispatchers.IO) {
                    try {
                        ...
                        zis.close()
                        withContext(kotlinx.coroutines.Dispatchers.Main) {
                            com.winlator.cmod.shared.android.AppUtils.showToast(context, R.string.saves_import_export_imported, android.widget.Toast.LENGTH_SHORT)
                            onDismissRequest()
                        }
                    } catch (e: Exception) {
                        e.printStackTrace()
                        withContext(kotlinx.coroutines.Dispatchers.Main) {
                            com.winlator.cmod.shared.android.AppUtils.showToast(context, getString(R.string.saves_import_export_imported_failed, e.message), android.widget.Toast.LENGTH_SHORT)
                        }
                    }
                }
            }
                        ...
                        onConfirm = {
                            if (isCustom) {
                                scope.launch(Dispatchers.IO) {
                                    ...
                                    withContext(Dispatchers.Main) {
                                        com.winlator.cmod.shared.android.AppUtils.showToast(context, getString(R.string.library_games_game_removed, app.name), android.widget.Toast.LENGTH_SHORT)
                                        onDismissRequest()
                                    }
                                }
                            } else if (isEpic) {
                                scope.launch(Dispatchers.IO) {
                                    ...
                                    withContext(Dispatchers.Main) {
                                        if (result.isSuccess) com.winlator.cmod.shared.android.AppUtils.showToast(context, getString(R.string.library_games_game_uninstalled, app.name), android.widget.Toast.LENGTH_SHORT)
                                        else com.winlator.cmod.shared.android.AppUtils.showToast(context, getString(R.string.library_games_failed_to_uninstall_reason, result.exceptionOrNull()?.message ?: "Unknown error"), android.widget.Toast.LENGTH_LONG)
                                        onDismissRequest()
                                    }
                                }
                            } else {
                                SteamService.uninstallApp(app.id) { success ->
                                    if (success) com.winlator.cmod.shared.android.AppUtils.showToast(context, getString(R.string.library_games_game_uninstalled, app.name), android.widget.Toast.LENGTH_SHORT)
                                    else com.winlator.cmod.shared.android.AppUtils.showToast(context, getString(R.string.library_games_failed_to_uninstall), android.widget.Toast.LENGTH_SHORT)
                                    onDismissRequest()
                                }
                            }
                        },
                    ...
                    UninstallConfirmation(
                        ...
                        onConfirm = {
                            scope.launch(Dispatchers.IO) {
                                ...
                                withContext(Dispatchers.Main) {
                                    com.winlator.cmod.shared.android.AppUtils.showToast(context, getString(R.string.library_games_game_uninstalled, app.title), android.widget.Toast.LENGTH_SHORT)
                                    onDismissRequest()
                                }
                            }
                        },
                                    ...
                                    Column(
                                        ...
                                        Row(
                                            ...
                                            CompactActionButton(
                                                ...
                                                onClick = {
                                                    val containerManager = ContainerManager(context)
                                                    val shortcut: com.winlator.cmod.runtime.container.Shortcut? = when {
                                            ...
                                            actions = listOf(
                                                GameSettingsActionItem(
                                                    ...
                                                    onClick = {
                                                        ...
                                                        com.winlator.cmod.shared.android.AppUtils.showToast(context, getString(R.string.google_cloud_sync_started), android.widget.Toast.LENGTH_SHORT)
                                                    },
                                                ),
                                                GameSettingsActionItem(
                                                    title = stringResource(R.string.common_ui_export),
                                        ...
                                        onConfirm = {
                                            if (isGog) {
                                                scope.launch(Dispatchers.IO) {
                                                    GOGService.deleteGame(
                                                        context,
                                                        LibraryItem("GOG_${gogGame!!.id}", gogGame.title, com.winlator.cmod.feature.stores.steam.enums.GameSource.GOG),
                                                    )
                                                    withContext(Dispatchers.Main) {
                                                        com.winlator.cmod.shared.android.AppUtils.showToast(context, getString(R.string.library_games_game_uninstalled, app.name), android.widget.Toast.LENGTH_SHORT)
                                                        onDismissRequest()
                                                    }
                                                }
                                            } else if (isCustom) {
                                                ...
                                                scope.launch(Dispatchers.IO) {
                                                    ...
                                                    withContext(Dispatchers.Main) {
                                                        if (result.isSuccess) com.winlator.cmod.shared.android.AppUtils.showToast(context, getString(R.string.library_games_game_uninstalled, app.name), android.widget.Toast.LENGTH_SHORT)
                                                        else com.winlator.cmod.shared.android.AppUtils.showToast(context, getString(R.string.library_games_failed_to_uninstall_reason, result.exceptionOrNull()?.message ?: ""), android.widget.Toast.LENGTH_LONG)
                                                        onDismissRequest()
                                                    }
                                                }
                                            } else {
    ...
    @Composable
    fun EpicStoreCapsule(app: com.winlator.cmod.feature.stores.epic.data.EpicGame, listMode: Boolean = false, isFocusedOverride: Boolean = false, isControllerActive: Boolean = false, onClick: () -> Unit) {
        val context = LocalContext.current
                ...
                if (app.cloudSaveEnabled) {
                    CompactActionButton(
                        ...
                        onClick = {
                            ...
                            onDismissRequest()
                            com.winlator.cmod.shared.android.AppUtils.showToast(context, context.getString(R.string.google_cloud_sync_started), android.widget.Toast.LENGTH_SHORT)
                        },
                    )
                }
                CompactActionButton(
        ...
        StoreInstallDialogShell(
            ...
            if (installed) {
                ...
                CompactActionButton(
                    ...
                    onClick = {
                        scope.launch(Dispatchers.IO) {
                            GOGService.deleteGame(context, LibraryItem("GOG_${app.id}", app.title, com.winlator.cmod.feature.stores.steam.enums.GameSource.GOG))
        ...
        Column(
            ...
            Row(
                ...
                Row(
                    ...
                    IconButton(
                        onClick = { queueSize++; PrefManager.downloadQueueSize = queueSize; com.winlator.cmod.feature.stores.steam.service.SteamService.checkQueue() },
                        modifier = Modifier.size(24.dp)
                    ) {
    ...
    private fun launchSteamGame(context: android.content.Context, containerManager: ContainerManager, app: SteamApp) {
        ...
        if (!gameDir.exists()) {
            com.winlator.cmod.shared.android.AppUtils.showToast(context, "Game not installed: ${app.name}", android.widget.Toast.LENGTH_SHORT)
            return
        }
        ...
        kotlinx.coroutines.CoroutineScope(kotlinx.coroutines.Dispatchers.Main).launch {
            ...
            if (shortcut != null) {
                ...
                com.winlator.cmod.shared.io.FileUtils.writeString(shortcut.file, rewritten.toString())
                shortcut.saveData()
                ...
                com.winlator.cmod.shared.io.FileUtils.writeString(shortcutFile, content.toString())
    ...
    private fun launchEpicGame(context: android.content.Context, containerManager: ContainerManager, app: EpicGame) {
        ...
        val gameDir = java.io.File(gameInstallPath)
        if (!gameDir.exists()) {
            com.winlator.cmod.shared.android.AppUtils.showToast(context, "Game not installed: ${app.title}", android.widget.Toast.LENGTH_SHORT)
            return
        }
    ...
    private fun ensureGameDrive(
        ...
        container.drives = com.winlator.cmod.runtime.wine.WineUtils.normalizePersistentDrives(
            this,
    ...
    private fun buildWineExecCommand(
        ...
        val windowsPath = container?.let {
            com.winlator.cmod.runtime.wine.WineUtils.getWindowsPath(it, exeFile.absolutePath)
        } ?: run {
    ...
    private fun launchCustomGame(context: android.content.Context, containerManager: ContainerManager, gameName: String) {
        ...
        if (shortcut == null) {
            ...
            for (container in containerManager.containers) {
                ...
                if (desktopFile.exists()) {
                    shortcut = com.winlator.cmod.runtime.container.Shortcut(container, desktopFile)
                    break
                }
            }
        }
        ...
        if (shortcut == null) {
            com.winlator.cmod.shared.android.AppUtils.showToast(context, "Custom game shortcut not found: $gameName", android.widget.Toast.LENGTH_SHORT)
            return
        }
    ...
    private fun launchGame(context: android.content.Context, intent: Intent) {
        ...
        if (context is android.app.Activity) {
            com.winlator.cmod.shared.android.AppUtils.applyOpenActivityTransition(context, 0, 0)
        }
    }
        ...
        val exePickerLauncher = rememberLauncherForActivityResult(
            ...
            if (uri != null) {
                ...
                if (path != null && (path.lowercase().endsWith(".exe") || java.io.File(path).exists())) {
                    ...
                    com.winlator.cmod.shared.android.AppUtils.showToast(context, "Please select a .exe file", android.widget.Toast.LENGTH_SHORT)
                }
            }
        }
                        ...
                        OutlinedButton(
                            onClick = {
                                if (selectedExePath == null || gameName.isBlank() || gameFolder == null) {
                                    com.winlator.cmod.shared.android.AppUtils.showToast(context, context.getString(R.string.library_games_select_exe_provide_name), android.widget.Toast.LENGTH_SHORT)
                                ...
                                scope.launch(Dispatchers.IO) {
                                    ...
                                    withContext(Dispatchers.Main) {
                                        isAdding = false
                                        com.winlator.cmod.shared.android.AppUtils.showToast(context, "$gameName added!", android.widget.Toast.LENGTH_SHORT)
                                        onDismiss()
                                    }
                                }
                            },
    ...
    private fun addCustomGame(context: android.content.Context, name: String, exePath: String, gameFolderPath: String) {
        ...
        ensureGameDrive(
            container,
            gameFolderPath,
            com.winlator.cmod.runtime.wine.WineUtils.getPreferredGameDriveLetter(gameFolderPath)
        )
